    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">Formulaire - Ajouter un Staff</h3>
            </div>
            <div class="content-header-right col-md-6 col-12 mb-2 text-right">
                <a href="/inscription/instructeur" class="btn btn-primary">
                    <i class="la la-plus"></i> Ajouter Instructeur
                </a>
            </div>
        </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    <form class="form form-horizontal form-bordered" action="/inscription/staff" method="post">
                                        <div class="form-body">
                                            <div class="form-group row mx-auto last">
                                                <label class="col-md-3 label-control" for="date-debut">Nom et Prenom : </label>
                                                <div class="col-md-9">
                                                    <%-- <input type="text" id="date-debut"  placeholder="" name="nom"> --%>
                                                    <input type="text" id="employeeInput" class="form-control" name="nominput" autocomplete="off" placeholder="Anarana feno...">
                                        ...
                                        <input type="hidden" id="employeeId" name="instructeurId">

                                        <!-- Champ pour l'année d'exercice avec suggestions -->
                                        <div class="form-body">
                                            <div class="form-group row mx-auto last">
                                                <label class="col-md-3 label-control" for="annee-exercice">Annee: </label>
                                                <div class="col-md-9">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group row mx-auto last">
                                                <label class="col-md-3 label-control" for="roleId">Role : </label>
                                                <div class="col-md-9">
                                                    <select id="roleId" name="roleId" class="form-control">
                                                        <option value="">-- Misafidiana Anjara asa --</option>
                                        ...
                                        <div class="form-actions">
                                            <a href="/liste/staffs"><button type="button" class="btn btn-warning mr-1"><i class="ft-x"></i> Annuler</button></a>
        ...
        $(document).ready(function() {
            ...
            function fetchInstructeur(searchTerm) {
                $.ajax({
                    ...
                    url: 'http://localhost:8081/api/inscription/instructeurs',
                    method: 'GET',
                    data: { 
                        search: searchTerm,
